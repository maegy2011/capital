                    ...
                    >
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{station.address || station.description}</p>
                          <div className="flex items-center space-x-3 mt-2 text-xs text-gray-600">
                            <span className="flex items-center">
                              <Clock className="h-3 w-3 mr-1" />
                              {t('available') || 'Available'}
                            </span>
                            {station.tripStations && station.tripStations.length > 0 && (
                              <span className="flex items-center">
                                <Bus className="h-3 w-3 mr-1" />
                                {station.tripStations.length} {t('routes') || 'routes'}
                              </span>
                            )}
                          </div>
                        </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {wallet ? `${wallet.currency} ${wallet.balance}` : t('loading') || 'Loading...'}
                      </p>
                    </div>
                  </div>
